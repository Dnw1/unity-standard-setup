...
[Serializable]
public class ConfigData { public WordList wordList; public PointAward pointAward; public Videos[] videos; public Audios[] audios; public Lighting[] lighting; public PostProcessing[] postProcessing; public Music[] music; }
[Serializable]
public class Videos  { public string name; public string subFolder; public float volume = 1.0f; }
[Serializable]
...
public class JsonStructure : MonoBehaviour {
    ...
    private void LoadConfigFromJsonString(string jsonString, string source) {
        ...
        try {
            ...
            if (root["wordList"] == null) Debug.LogWarning("[Json] 'wordList' missing");
    ...
    private void LoadDefaultConfig() {
        ...
        var defaultConfig = new ConfigData {
            videos = new Videos[0], audios = new Audios[0], wordList = new WordList { words = new List<string> { "GROOTS" } },
            pointAward = new PointAward { correctWord = 100f, maxTimeAward = 120f, minTimeAward = 5f }
        };
        BindManagersIfNeeded();
